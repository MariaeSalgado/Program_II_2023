package com.gruposeven.myapplication.SQL;
...
import com.gruposeven.myapplication.LoginActivity;
import com.gruposeven.myapplication.R;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (accion.equals("modificar")){
            ...
            btnregresar.setOnClickListener(view1 -> {
                Intent r = new Intent(AgregarProducto.this, LoginActivity.class);
                startActivity(r);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (jsonObject.getBoolean("ok")){
                    ...
                    Intent regresar = new Intent(AgregarProducto.this, LoginActivity.class);
